...
def get_args():
    ...
    parser.add_argument('--normlize_target', action='store_true')
    ...
    # Dataset parameters
    parser.add_argument('--root_path', default='/datasets01/imagenet_full_size/061417/train', type=str,
                        help='dataset path')
